...
$route  = $_SERVER['HTTP_X_ROUTE'] ?? 'nome_credilink';
...
// ================= PARÂMETROS =================
// parâmetro deve ter o MESMO nome da rota
$nome = $_GET['nome_credilink'] ?? '';
...
// ================= ENDPOINT REAL =================
$url = 'https://vps-gonzales.duckdns.org/apis/api.php?nome=' . urlencode($nome);
